    ...
    <header class="header_section">
        <div class="container">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                <a class="navbar-brand" href="home"><img width="250" src="images/logo.png" alt="Logo" /></a>
                        ...
                        <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                                <div class="detail-box">
                                    ...
                                    <div class="btn-box">
                                        <a href="{{ url('/') }}/AllProducts" class="btn1">
                                            Shop Now
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="box">
                            {{-- <div class="option_container">
                                <div class="options">
                                    ...
                                    <a href="{{ url('/') }}/addToCart/{{ $products['id'] }}" class="option3">
                                        Add To Cart
                                    </a>
                                </div>
                            </div> --}}
                            <a href="{{ url('/') }}/ProductView/{{ $products['id'] }}" class="option3">
                                <div class="img-box">
            ...
            <div class="box">
                ...
                <div class="row">
                    <div class="col-md-6 ml-auto">
                        ...
                        <a href="{{ url('/') }}/AllProducts">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
